...
const sections = [
  ...
  { title: "Artifacts", blurb: "The Ninefold and the Cryptex — objects from inside the story." },
];

export default function PreviewGravityLens() {
  const logoRef = useRef(null);

  return (
    <div style={{ position: "relative", minHeight: "100vh" }}>
      <GravityLens anchorRef={logoRef} />
      <div style={{ position: "relative", zIndex: 1, maxWidth: 1000, margin: "0 auto", padding: "48px 32px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 50 }}>
          <div className="mono" style={{ fontSize: 11, color: "#6E76B8", letterSpacing: "1px", marginBottom: 20 }}>
            LOOK PREVIEW &mdash; GRAVITATIONAL LENSING
          </div>
          <div ref={logoRef} style={{ maxWidth: 300, margin: "0 auto" }}>
            <SignalLogo />
          </div>
          <div
            className="mono"
          ...
          <p style={{ color: "#B7BADF", maxWidth: 520, margin: "0 auto" }}>
            Not decoration — this is what 13i's own creators would actually
            perceive. Nothing lit up, nothing glowing. Just the shape of
            space itself, bent around the one point paying attention.
          </p>
        </div>
